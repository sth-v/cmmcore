...
namespace cmmcore {
    ...
    struct PatchIntersection {
        ...
        PatchIntersection(const NURBSSurface& _s1, const NURBSSurface& _s2,const IntersectionPoint& a,const IntersectionPoint& b ): s1(_s1), s2(_s2),start(a),end(b)
        {
    ...
    inline void processSimpleSurfaceIntersection(const NURBSSurface& surface1,  const NURBSSurface& surface2, const double tol,Intersection& intersection)
    {
    ...
    inline void detectIntersections(  NURBSSurface& surface1, NURBSSurface& surface2,  NURBSSurface&  gaussMap1,
                                     NURBSSurface&  gaussMap2, const double tol, Intersection& intersection, int depth=0)
    {
         counter++;
    ...
    inline void find_start_points( NURBSSurface& surface1, NURBSSurface& surface2,const double tol,  std::vector<IntersectionPoint> &intersectionPoints )
    {
    ...
    inline void detectAllInts(const NURBSSurface& ns1,const NURBSSurface& ns2, const double tol,cmmcore::Intersection& intersection) {
