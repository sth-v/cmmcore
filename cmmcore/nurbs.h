...
namespace cmmcore {
    ...
    [[nodiscard]] std::pair<NURBSCurve, NURBSCurve> split(const double param, const bool normalize_knots=false) const {
        ...
        // Insert knot
        NURBSCurve temp_obj(this->_control_points, this->_degree,this->_knots,this->_periodic);temp_obj._update_interval();
